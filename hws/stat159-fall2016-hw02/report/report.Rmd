...
library(stargazer)
t = read.table("~/Desktop/git/mosmart/stat159-Morgan-Smart/hws/stat159-fall2016-hw02/data/eda-output.txt", sep="\t", header=T)
stargazer(t, summary=FALSE, header=F)
```
As evident from Table 1, the range of TV advertising budget ($700 to $296,400) is much larger than the range of product sales is from 1,600 to 27,000. This in turn makes the standard deviation of TV advertising budget ($85,850) much greater than that of product sales ($5,220).  
